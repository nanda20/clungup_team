        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin: auto;" class="email-container">
            <tr>
                <td style="padding: 20px 0; text-align: center">
                    <img src="https://lh4.googleusercontent.com/wTSrToZkfEKCmrz_xsBHMTTo-QoGumJAlKsHxTMtTC91sun4nB_bY4GFzw-n6BhKvQ7ZaBvhkCtmFBYaLR22=w1366-h637" width="292" alt="Clungup Mangroove Conservation"">
                </td>
            </tr>
        </table>
        <!-- Email Header : END -->
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin: auto;" class="email-container">
            ...
            <tr>
                <td bgcolor="#ffffff" style="padding: 40px 40px 20px; text-align: center;">
                    <h1 style="margin: 0; font-family: sans-serif; font-size: 24px; line-height: 125%; color: #333333; font-weight: normal;">Pesanan anda</h1>
                </td>
            </tr>
            <tr>
	                    ...
	                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
	                        <tr>
	                            <td style="padding: 40px; text-align: left; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #ffffff;">
	                                <p style="margin: 0;">Terima kasih telah melakukan pemesanan. Untuk proses lebih lanjut silahkan melakukan melalui rekening yang tertera diatas. Jika anda tidak melakukan pembayaran, maka pemesanan akan kami batalkan</p>
	                            </td>
	                        </tr>
	                    </table>
	                    <!--[if mso]>
